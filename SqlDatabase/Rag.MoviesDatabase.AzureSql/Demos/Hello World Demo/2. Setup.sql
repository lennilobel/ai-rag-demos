...
BEGIN
	...
	DECLARE @OpenAIDeploymentName varchar(max) = 'lenni-text-embedding-3-large'			-- The 'Text Embedding 3 Large' model yields 3072 components (floating point values) per vector
